...
public class Constants : MonoBehaviour
{
    ...
    public static string GAZE_INPUT = "GAZE_INPUT";

    public static string SHOW_FACT = "SHOW_FACT";
    ...
    public static string MARS_MOVED_LISTENER = "MARS_MOVED_LISTENER";
    public static string MARS_MOVED_UPDATE_POSITION = "MARS_MOVED_UPDATE_POSITION";
